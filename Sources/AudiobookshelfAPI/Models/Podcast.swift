...
public struct Podcast {
    ...
    /// The maximum number of podcast episodes to keep when automatically downloading new episodes. Episodes beyond this
    /// limit will be deleted. If 0, all episodes will be kept.
    public let maxEpisodesToKeep: Int

    /// The maximum number of podcast episodes to download when automatically downloading new episodes. If 0, all
