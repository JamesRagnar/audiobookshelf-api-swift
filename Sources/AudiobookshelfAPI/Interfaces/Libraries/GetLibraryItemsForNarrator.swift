...
/// This endpoint returns a library's items filtered to a narrator.
public struct GetLibraryItemsForNarrator: Interface {
    ...
    public struct Request: InterfaceRequest {
        ...
        public init(
            ...
            queryItems = GetLibraryItems.Request(
                ...
                filter: LibraryItemFilter.narrator(narratorName),
                minified: minified,
